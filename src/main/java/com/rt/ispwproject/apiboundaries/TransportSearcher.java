...
public class TransportSearcher {
    ...
    public List<TransportOffer> searchTransports(String departureLocation, String arrivalLocation,
                                                 Duration departureAnsReturnDates, int numOfTravelers) throws ApiException
    {
        ...
        List<TransportOffer> offers = null;

        // Parse json content and create list of bean classes
        try {
            Type collectionType = new TypeToken<List<TransportOffer>>(){}.getType();
            Gson gson = new Gson();
